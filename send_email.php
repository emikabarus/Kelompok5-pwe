...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->setFrom('miraenk7@gmail.com', 'Sender'); // Nama pengirim
        $mail->addAddress('bagas@ae.polman-bandung.ac.id', 'Bagas'); // Email penerima
        $mail->addCC('budi@ae.polman-bandung.ac.id', 'Budi');  // CC
        ...
        if ($format == 'xlsx') {
            ...
            $mail->addAttachment('uploads/data-baris.pdf'); // Path ke file PDF
        } else {
